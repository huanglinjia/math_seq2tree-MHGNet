...
def train_tree(input_batch, batch_graph, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
    ...
    encoder_outputs, problem_output = encoder(input_var, batch_graph, input_length)
    # Prepare input and output variables
...
def evaluate_tree(input_batch, batch_graph, input_length, generate_nums, encoder, predict, generate, merge, output_lang, num_pos,
